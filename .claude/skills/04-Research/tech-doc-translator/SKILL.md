...
description: Use when translating English technical documentation (AI/ML, developer
  tools, API docs) into Chinese Markdown. Triggers on requests to translate docs,
  localize content, or convert English technical writing to Chinese.
version: 1.0.0
author: Robin
license: Apache-2.0
platforms:
